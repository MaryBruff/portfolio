    ...
    <main className="min-h-screen bg-gradient-to-b from-pink-700 to-pink-900 text-white relative">
      <div className="mx-auto max-w-6xl px-4 md:px-6 py-6 space-y-6">
        ...
        <Window title="Explore Work">
          <Card className="border-pink-500 bg-pink-800 bg-opacity-50 portfolio-font">
            <CardHeader>
              <CardTitle className="text-xl text-pink-300 animate-blink">Explore Other Work</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { title: "Software Development", href: "/work/software" },
                  { title: "UI/UX & Content Strategy", href: "/work/ui-ux" },
                  { title: "Multimedia & Motion", href: "/work/multimedia" },
                  { title: "Creative & Performance", href: "/work/creative" },
                  { title: "Marketing & Strategy", href: "/work/marketing" },
                ].map((link) => (
                  <Button
                    key={link.title}
                    variant="outline"
                    className="border-pink-500 hover:bg-pink-300 hover:text-pink-950 portfolio-font transition-transform hover:scale-105"
                    asChild
                  >
