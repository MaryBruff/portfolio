  ...
  return (
    <div className="text-sm space-y-4">
      <div>
        ...
        >
          <img
            src="https://text.glitter-graphics.net/mixed/a.gif"
            alt="a"
            className="inline-block"
            style={{ border: 0 }}
          />
          <img
            src="https://text.glitter-graphics.net/mixed/b.gif"
            alt="b"
            className="inline-block"
            style={{ border: 0 }}
          />
          <img
            src="https://text.glitter-graphics.net/mixed/o.gif"
            alt="o"
            className="inline-block"
            style={{ border: 0 }}
          />
          <img
            src="https://text.glitter-graphics.net/mixed/u.gif"
            alt="u"
            className="inline-block"
            style={{ border: 0 }}
          />
          <img
            src="https://text.glitter-graphics.net/mixed/t.gif"
            alt="t"
            className="inline-block"
            style={{ border: 0 }}
          />
          ...
          />
          <img
            src="https://text.glitter-graphics.net/mixed/m.gif"
            alt="m"
            className="inline-block"
            style={{ border: 0 }}
          />
          <img
            src="https://text.glitter-graphics.net/mixed/e.gif"
            alt="e"
            className="inline-block"
            style={{ border: 0 }}
          />
