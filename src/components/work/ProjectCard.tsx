    ...
    <fieldset className="relative"> {/* anchor for absolute footer */}
      ...
      <CardContent className="px-2 pb-12">
        <Link href={url} target="_blank">
          <div className="relative w-full h-32 overflow-hidden rounded-lg border-2 border-pink-400 mb-4">
            <Image src={effectiveThumbnail} alt={title} fill className="object-cover" />
            {isVideo && (
              <div className="absolute inset-0 flex items-center justify-center">
                <svg className="w-12 h-12 text-pink-400 opacity-80 hover:opacity-100" fill="currentColor" viewBox="0 0 24 24">
